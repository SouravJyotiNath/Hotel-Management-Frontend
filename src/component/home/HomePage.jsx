...
const HomePage = () => {
    ...
    return (
        <div className="home">
            <section>
                <header className="header-banner">
                    ...
                    <div className="animated-texts overlay-content">
                        <h1>
                            Welcome to <span className="phegon-color">Okeanos Hotel</span>
                        </h1><br />
                        <h3>Step into a sanctuary of comfort and exceptional care.</h3>
                    </div>
                </header>
            </section>
            ...
            <h2 className="home-services">Services at <span className="phegon-color">Okeanos Hotel</span></h2>
